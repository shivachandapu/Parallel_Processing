...
The board is made up of an n x n grid of cells, where each cell has an initial state: live (represented
...
where births and deaths occur simultaneously. Given the current state of the n x n grid board,
...
int main(int argc, char* argv[]){
    ...
    input_mat = create_mat(n+2);  //creating a padded matrix
    output_mat = create_mat(n+2);
